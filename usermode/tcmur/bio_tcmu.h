/* bio_tcmu.h
 * Shim to run tcmu-runner plugins under bio Usermode Compatibilty
...
struct tcmulib_cmd {
    ...
    struct bio		      * bio;		/* block I/O operation */
...
/* bio_tcmu private structure -- handlers should use accessors */
struct tcmu_device {
    void		      * hm_private;		/* owned by handler */
    struct tcmur_handler      * handler;
    struct bdev_tcmu	      * bdev_tcmu;			/* our device */
...
extern void tcmu_bio_exit(void);

/* The purpose of tcmu_get_device_size() seems to be to allow the driver to ask
