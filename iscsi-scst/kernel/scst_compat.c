...
extern void fuse_modparm_add_num_threads(void);
extern void fuse_modparm_add_scst_vdisk_ID(void);
extern void fuse_modparm_add_scst_threads(void);
extern void fuse_modparm_add_scst_max_cmd_mem(void);
extern void fuse_modparm_add_scst_max_dev_cmd_mem(void);
extern void fuse_modparm_add_forcibly_close_sessions(void);
...
SCST_init(void)
{
    ...
    fuse_modparm_add_scst_threads();
    fuse_modparm_add_scst_max_cmd_mem();
    fuse_modparm_add_scst_max_dev_cmd_mem();
    fuse_modparm_add_forcibly_close_sessions();
...
extern void fuse_modparm_remove_num_threads(void);
extern void fuse_modparm_remove_scst_vdisk_ID(void);
extern void fuse_modparm_remove_scst_threads(void);
extern void fuse_modparm_remove_scst_max_cmd_mem(void);
extern void fuse_modparm_remove_scst_max_dev_cmd_mem(void);
extern void fuse_modparm_remove_forcibly_close_sessions(void);
...
SCST_exit(void)
{
    ...
    fuse_modparm_remove_num_threads();
    fuse_modparm_remove_scst_vdisk_ID();
    fuse_modparm_remove_scst_threads();
    fuse_modparm_remove_scst_max_cmd_mem();
...
SCST_nl_open(void)
{
    ...
    verify_rc(err, UMC_socketpair);
    assert_eq(SCST_nl_fdwrite, -1);
	   ...
	   enum iscsi_kern_event_code code, const char * param1, const char * param2)
{
    ...
    /* Assumes writev(2) is OK with zero-length iov_len elements */
    struct iovec iov[] = {
